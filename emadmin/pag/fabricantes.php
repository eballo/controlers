...
<div class='formularioAlta' id='formularioAlta'>
	...
	<div class='textFormAlta'><input type='text' />Nombre</div>
	<div class='textFormAlta'><input type='text' />Dirección</div>
	<div class='textFormAlta'><input type='text' />Otros Datos</div>
	...
	<form action='pag/uploadimg.php' target='imagen' id='formAlta' method='POST' enctype="multipart/form-data">
		<div class='textFormAlta'><input type='file' name='fileUpload' id='imagenAlta'/>Imagen</div><br><br>
	</form>
