...
<?php
$db = new Dbs();
$db->query("SELECT * from producto ORDER by ID_Produc");
	...
	echo "
		<tr id='".$res[1]."'>
			<td width='80px' height='80px'>
				<div class='imagenpro'>
					<img class='imagenpro' style='opacity:0.8;cursor:pointer;' src='../em/gestp/".$res[4]."' width=70px height=70px'/>
				</div>
			</td>
			...
			<td><div class='header'>Fabricante</div><div class='data'>".$res[3]."</div></td>
			<td><div class='header'>Tipo de producto</div><div class='data'>".$res[5]."</div></td>
			<td><div class='header'>Oferta</div><div class='data'>".$res[6]."</div></td>
			<td width='50px' height='50px'><img onclick=eliminar('".$res[1]."') style='opacity:0.8;cursor:pointer;' src='img/eliminar.png' width='50px' height='50px'></img></td>
			</tr>
		";
